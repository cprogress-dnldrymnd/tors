        ...
        <div class="inner-page">
            <div class="main-banner">
                <div class="main-title">
                    ...
                    <h1><?php if ( is_day() ) :
                    printf( esc_html__( 'Daily Archives: %s', 'moroko' ), get_the_date() );
                    elseif ( is_month() ) :
                        printf( esc_html__( 'Monthly Archives: %s', 'moroko' ), get_the_date( _x( 'F Y', 'monthly archives date format', 'moroko' ) ) );
                    elseif ( is_year() ) :
                        printf( esc_html__( 'Yearly Archives: %s', 'moroko' ), get_the_date( _x( 'Y', 'yearly archives date format', 'moroko' ) ) );
                    else :
                        echo esc_html__( 'Archives', 'moroko' );
                    endif;?></h1>
                </div>
            </div>
            <!-- Start: Object Image-->
