            ...
            <div class="main-banner">
                <div class="main-title">
                      ...
                      <?php echo esc_html__( 'Here is some thought from us', 'moroko' ); } ?></span>
                        <h1><?php printf( esc_html__( 'Search Results for: %s', 'moroko' ), get_search_query() ); ?></h1>
                    </div>
            </div>
            <!-- Start: Object Image-->
                        ...
                        <div class="blog-items-area ">
                            ...
                            <div class="single-news one-item horizontal-news">
                                <div class="search-custom search-no-result" >
                                    ...
                                    echo esc_html__( 'Sorry, but nothing matched your search terms. Please try again with some different keywords.', 'moroko' ) ;?> 
                                    </h4>
                                    <?php get_search_form();  ?>
                                </div>
                            </div>
