...
<!-- Preloader Area Start 
    ...
    <!-- Header Area Start 
    ====================================================== -->
    <header class="header-area index-1">
        <div class="container">
            <div class="top-bar">
                <!-- Start: Top Logo -->
                <div class="col-md-2 logobar">
                    <div class="logo">
                        <a href="<?php echo esc_url(home_url('/')); ?>">
                            <?php if(isset($moroko_redux_demo['logo_white']['url']) && ($moroko_redux_demo['logo_white']['url'] != '')){?>
                            <img src="<?php echo esc_url($moroko_redux_demo['logo_white']['url']); ?>" alt="">
                            <?php }else{ ?>
                            <img src="<?php echo get_template_directory_uri();?>/img/top-logo-white.png" alt="">
                            <?php } ?>
                        </a>
                    </div>
                </div>
