...
class TorsDevTestimonials extends \Elementor\Widget_Base {
    ...
    public function get_title() {
        return __( 'Testimonials', 'torsdev-elementor' );
    }
    ...
    protected function _register_controls() {
        ...
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__( 'Testimonials', 'torsdev-elementor' ),
            ]   
        );
        $this->add_control(
            'subheading',
        ...
        $this->add_control(
            ...
            [
                ...
                'fields' => [
                    ...
                    [
                        'name'        => 'text',
                        'label'       => esc_html__( 'Text:', 'torsdev-elementor' ),
                        'type'        => Controls_Manager::TEXTAREA,
                        'dynamic'     => [ 'active' => true ],
                        'default'     => esc_html__( 'This is text' , 'torsdev-elementor' ),
                        'label_block' => true,
                    ],
                    [
                        'name'        => 'name',
                        'label'       => esc_html__( 'Name:', 'torsdev-elementor' ),
                        'type'        => Controls_Manager::TEXT,
                        'dynamic'     => [ 'active' => true ],
                        'default'     => esc_html__( 'This is name' , 'torsdev-elementor' ),
                        'label_block' => true,
                    ],
                    [
                        'name'        => 'job',
                        'label'       => esc_html__( 'Job:', 'torsdev-elementor' ),
                        'type'        => Controls_Manager::TEXT,
                        'dynamic'     => [ 'active' => true ],
                        'default'     => esc_html__( 'This is job' , 'torsdev-elementor' ),
                        'label_block' => true,
                    ],
                ],
            ]
