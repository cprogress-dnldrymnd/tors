 ...
 * @since 1.0.0
 */
class TorsDevBanner2 extends \Elementor\Widget_Base {
    ...
    public function get_title() {
        return __( 'Banner 2', 'torsdev-elementor' );
    }
    ...
    protected function _register_controls() {
        ...
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__( 'Banner 2', 'torsdev-elementor' ),
            ]   
        );
        $this->add_control(
            'banner_image',
    ...
    <section class="banner-sec">
        <div class="main-banner" style=" background:url(<?php echo wp_kses_post($settings['banner_image']['url']); ?>) no-repeat top center fixed; background-size:cover;">
            <div class="container">
                <div class="slider">
                    <div class="flexslider">
                        <ul class="slides">
                            ...
                            <li>
                                <div class="caption">
                                    <figure><img src="<?php echo wp_kses_post($item['banner_image']['url']); ?>"  alt=""></figure>
                                    ...
                                    <p>
                                        <span><?php print wp_kses_post($item['button_description']); ?></span>
                                        <span><a class="ellipse" href="<?php print wp_kses_post($item['link_button']); ?>"></a></span>
                                    </p>
                                    <?php } ?>
                                </div>
                            </li>
                ...
                <a  class="rounded-rectangle" href="<?php echo esc_url(home_url('/')); ?>#scroll-top-div" > <i class="fa fa-angle-down"></i></a>
                <a id="scroll-top-div" href="#" name="scroll-top-div"></a>
            </div>
        </div>
    </section>
    <!-- =================================================
