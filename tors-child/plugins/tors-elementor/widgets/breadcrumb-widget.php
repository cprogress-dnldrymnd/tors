 ...
 * @since 1.0.0
 */
class TorsDevBreadcrumb extends \Elementor\Widget_Base {
    ...
    public function get_title() {
        return __( 'Breadcrumb', 'torsdev-elementor' );
    }
    ...
    protected function _register_controls() {
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__( 'Breadcrumb', 'torsdev-elementor' ),
            ]   
        );
        $this->add_control(
            'banner_image',
        ...
        <section class="banner-sec">
            <div class="inner-page">
                ...
                <div class="object-image-sec">
                    <div class="object" style="background:url(<?php echo wp_kses_post($settings['banner_image']['url']); ?>) no-repeat center center"></div> 
                </div>
                <!-- End : Object Image -->
            </div>
        </section>
