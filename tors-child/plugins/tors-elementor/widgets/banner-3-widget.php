 ...
 * @since 1.0.0
 */
class TorsDevBanner3 extends \Elementor\Widget_Base {
    ...
    public function get_title() {
        return __( 'Banner 3', 'torsdev-elementor' );
    }
    ...
    protected function _register_controls() {
        ...
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__( 'Banner 3', 'torsdev-elementor' ),
            ]   
        );
        $this->add_control(
            'tabs',
            ...
            <div class="slider">
                <div class="flexslider">
                    <ul class="slides">
                        ...
                        <li>
                            <img src="<?php echo wp_kses_post($item['banner_image']['url']); ?>"  alt="">
                            <div class="caption">
                                ...
                                <a class="ellipse" href="<?php print wp_kses_post($item['link_button']); ?>"></a>
                                <?php } ?>
                            </div>
                        </li>
                        <!-- End: Banner Slide 01 -->
